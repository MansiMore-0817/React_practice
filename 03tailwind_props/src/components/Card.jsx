...
function Card({channel, someObj, myArray, btnText}) {
  ...
  return (
    <>
      ...
      <div>
        <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group mb-4">
          ...
          <div className="mb-4">
            ...
            <h2 className="text-xl font-bold text-white mb-2 group-hover:text-gray-300 transition-colors duration-200">
              {channel} - Design Patterns for Modern Interfaces
            </h2>
          </div>
